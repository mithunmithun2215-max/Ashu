...
/* ========= OBFUSCATED CREDIT LOCK ========= */

function _0x46d6(_0x70490e,_0x5ee597){
const _0x20973e=_0x2097();
return _0x46d6=function(_0x46d61b,_0x12c85c){
_0x46d61b=_0x46d61b-0x10e;
let _0x15a637=_0x20973e[_0x46d61b];
return _0x15a637;
},_0x46d6(_0x70490e,_0x5ee597);
}

const _0x1575bf=_0x46d6;

(function(_0x582c80,_0x432329){
const _0x36ebb0=_0x46d6,_0x208c06=_0x582c80();
while(!![]){
try{
const _0x8fb936=
parseInt(_0x36ebb0(0x112))/0x1+
parseInt(_0x36ebb0(0x114))/0x2*
(-parseInt(_0x36ebb0(0x110))/0x3)+
-parseInt(_0x36ebb0(0x113))/0x4*
(-parseInt(_0x36ebb0(0x10e))/0x5)+
-parseInt(_0x36ebb0(0x111))/0x6+
-parseInt(_0x36ebb0(0x116))/0x7+
parseInt(_0x36ebb0(0x115))/0x8*
(-parseInt(_0x36ebb0(0x118))/0x9)+
parseInt(_0x36ebb0(0x10f))/0xa;

if(_0x8fb936===_0x432329) break;  
        else _0x208c06.push(_0x208c06.shift());  
    }catch(_0x4303b3){  
        _0x208c06.push(_0x208c06.shift());  
    }  
}
...
'65224tuKqSx',
'2594095zRddin',
'357e33b5568a7388199e9df32b4626c8', // MD5 of ARIF BABU
'153RqNopc',
'155NggJZU',
'12172580DebcTG',
'123780EOBSlY',
...
_0x2097=function(){return _0x2983ed;};
return _0x2097();
}

const creditsHash = _0x1575bf(0x117);

function validateCredits(configCredits){
const currentHash = crypto.createHash("md5")
.update(configCredits)
.digest("hex");
...
if (!validateCredits(module.exports.config.credits)) {  
    return api.sendMessage(  
        "⚠️ Unauthorized credit modification detected!",  
        threadID,  
        messageID  
    );  
}  
...
const filePath = __dirname + "/cache/dp.jpg";  
...
if (!validateCredits(module.exports.config.credits)) {
console.warn("⚠️ Credit modification detected!");
}
};